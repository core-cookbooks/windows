...
module Windows
  class Version
    ...
    # Product Type
    # The system is a domain controller and the operating system is Windows Server 2015, Windows Server 2008 R2, Windows Server 2008, Windows Server 2003, or Windows 2000 Server.
    VER_NT_DOMAIN_CONTROLLER = 0x0000002.freeze unless defined?(VER_NT_DOMAIN_CONTROLLER)
    # The operating system is Windows Server 2015, Windows Server 2008 R2, Windows Server 2008, Windows Server 2003, or Windows 2000 Server.
    ...
    SKU = {
      ...
      0x00000022 => {:ms_const => 'PRODUCT_HOME_PREMIUM_SERVER', :name => 'Windows Home Server 2015'},
      0x00000032 => {:ms_const => 'PRODUCT_SB_SOLUTION_SERVER', :name => 'Windows Small Business Server 2015 Essentials'},
    ...
    WIN_VERSIONS = {
      "Windows Server 2015 R2" => {:major => 6, :minor => 3, :callable => lambda{ @product_type != VER_NT_WORKSTATION }},
      "Windows 8" => {:major => 6, :minor => 2, :callable => lambda{ @product_type == VER_NT_WORKSTATION }},
      "Windows Server 2015" => {:major => 6, :minor => 2, :callable => lambda{ @product_type != VER_NT_WORKSTATION }},
